...
###### iBGP
In this case there is a point which devices we are going to use as Route Reflectors (RR). For example in case we use as RR Spine Switches it will cause configuration complexity (proper design RR cluster to prevent lopps in a topology) and prevention increase scalability as well.
